...
// */
//case class SelectInContainmentTreeAction(val e: Element)( implicit umlUtil: MagicDrawUMLUtil )
...
//    p != null && !p.isDisposed(e)
//  }
//
//  def execute( annotation: Annotation ): Unit =
//    com.nomagic.magicdraw.uml.actions.SelectInContainmentTreeAction.selectInBrowser(e)
//
//}