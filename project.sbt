...
name := "imce.oti.uml.magicdraw.dynamicscripts"

description := "JPL IMCE MagicDraw Dynamic Scripts for operating on MD models through the OMG Tool-Neutral Interoperability (OTI) API."
